...
def main():
    parser = argparse.ArgumentParser(
        description="Verify AoM EE PBRify V4 canary output."
    )
    ...
    passed = (
        ...
        decode_pass == 44 and
        dimension_pass == 44 and
        alpha_pass == 44
    )

    print("==============================================")
    print("AoM EE PBRIFY V4 CANARY OUTPUT QA")
    print("==============================================")
    ...
    if passed:
        print("PBRIFY V4 CANARY QA: PASS")
        return 0

    print("PBRIFY V4 CANARY QA: FAIL")
    return 1
